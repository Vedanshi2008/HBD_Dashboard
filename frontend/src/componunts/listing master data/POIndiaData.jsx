  ...
  return (
    <div className="mt-12 mb-8 flex flex-col gap-12 px-4">
      <Card>
        ...
        >
          <Typography variant="h6" color="white">PO India</Typography>
            ...
            <tbody>
              {data.map((item, idx) => (
                <tr key={idx}>
                  ...
                  <td className="py-3 px-5">{item.area_name|| "-"}</td>
                  <td className="py-3 px-5">{item.taluka_name|| "-"}</td>
                  <td className="py-3 px-5">{item.city_name|| "-"}</td>
                  <td className="py-3 px-5">{item.state_name|| "-"}</td>
